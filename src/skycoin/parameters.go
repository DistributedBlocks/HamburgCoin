...
func setDefaults() {
	...
	viper.SetDefault("node.port", 9600)
	viper.SetDefault("node.web_interface_port", 9620)
	...
	viper.SetDefault("visor.initial_unlocked_count", 100)
	viper.SetDefault("visor.unlock_address_rate", 0)
